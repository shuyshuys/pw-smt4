    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gradient-dark" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/material-dashboard/pages/dashboard " target="_blank">
                ...
                <span class="ms-1 font-weight-bold text-white">Backend Dashboard
                </span>
            </a>
        </div>
        ...
        <div class="sidenav-footer position-absolute w-100 bottom-0">
            <div class="mx-3">
                <a class="btn bg-gradient-primary mt-4 w-100" href="https://itconsultant.shuyshuys.repl.co/" type="button">Main webpages</a>
            </div>
        </div>
    </aside>
                    ...
                    <ul class="navbar-nav justify-content-end">
                        <li class="nav-item d-flex align-items-center">
                            <a href="javascript:;" class="nav-link text-body font-weight-bold px-0">
                                ...
                                <span class="d-sm-inline d-none"><a href="pages/authentication/logout.php">Logout</a></span>
                            </a>
                        </li>
                    ...
                    <div class="row align-items-center justify-content-lg-between">
                        <div class="col-lg-6 mb-lg-0 mb-4">
                            <div class="copyright text-center text-sm text-muted text-lg-start">
                                ...
                                <a href="https://itconsultant.shuyshuys.repl.co/" class="font-weight-bold" target="_blank">Kelompok 2</a>
                                .
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                                <li class="nav-item">
                                    <a href="https://itconsultant.shuyshuys.repl.co/pages/kontak/teams.php" class="nav-link text-muted" target="_blank">Tim Kelompok 2 Basis Data</a>
                                </li>
                                <li class="nav-item">
                                    <a href="https://itconsultant.shuyshuys.repl.co/" class="nav-link text-muted" target="_blank">Blog</a>
                                </li>
                            </ul>
                        </div>
                    </div>
